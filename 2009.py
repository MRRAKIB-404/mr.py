...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : MR RAKIB 
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : UNKNOWN  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : MRRAKIB-404
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [MR] : %s/%s -> \033[0;92m [ RAKIB-OK:%s ]- \033[0;91m[MR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Instagram : https://instagram.com/mr__RAKIB__official")
		print(" [*] YouTube   : https://m.youtube.com/channel/UCO_zr6mvzzFRwADFiVjVY1w")
